...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      'libs/modules/rules/backend/infrastructure/src/lib/persist-imported-ruleset.spec.ts',
      'libs/modules/rules/backend/infrastructure/src/lib/rules-authoring-workflow.spec.ts',
      'libs/modules/rules/backend/infrastructure/src/lib/wazuh-xml-ruleset-analyzer.spec.ts',
    ],
